import{a as g,j as e,N as v,s as S,d as j,u as k,b as l,c as y,r as d,e as P,L as C}from"./index-fc6ea2c6.js";import{T as w}from"./Title-67ec1cd2.js";import{D as F,P as D}from"./Pagination-aba6f213.js";import{S as L,a as N,b as E,c as z,d as W,e as b,f as I,g as T}from"./DrinkCard.styled-83e1ab2f.js";import{s as M,a as B,b as R}from"./selectors-339aa893.js";import{N as _}from"./NotFound-c5c103ea.js";const $=({name:a,description:n,alcoholic:c,imgUrl:i,id:r})=>{const h=g(),o=s=>{h(j(s))};return e.jsxs(L,{children:[e.jsx(N,{src:i,alt:a}),e.jsxs("div",{children:[e.jsx(E,{children:a}),e.jsx(z,{children:c})]}),e.jsx(W,{children:n}),e.jsxs(b,{children:[e.jsx(v,{to:`/drink/${r}`,children:e.jsx(I,{children:"See more"})}),e.jsx(T,{onClick:()=>o(r),children:e.jsx("svg",{children:e.jsx("use",{xlinkHref:`${S}#icon-trash`})})})]})]})},A=k.div`
  margin-top: 40px;
  display: flex;
