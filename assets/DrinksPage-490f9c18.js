import{r as o,u as s,j as e,N as C,a as L,b as g,c as D,p as f,L as F}from"./index-d39268e7.js";import{a as P,S as B,b as N,c as z,d as I,e as T,D as E,P as A}from"./Pagination-fefb0f58.js";import{T as M}from"./Title-3c3a775f.js";import{N as V}from"./NotFound-4fe30493.js";import{f as W,g as q}from"./drinks.selectors-cc3f5dd0.js";const O=t=>o.createElement("svg",{width:20,height:20,viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",...t},o.createElement("path",{d:"M9.16667 15.8333C12.8486 15.8333 15.8333 12.8486 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333Z",stroke:"#F3F3F3",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round"}),o.createElement("path",{d:"M17.5 17.5L13.875 13.875",stroke:"#F3F3F3",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round"})),R=s(O)`
  width: 28px;
  height: 28px;
...
`,ne=()=>{const t=L(),[i,r]=o.useState(1),n=g(W),l=g(q),[k]=D(),d=k.get("page")||1,[c,v]=o.useState(""),[p,y]=o.useState(""),[h,S]=o.useState(""),w=new URLSearchParams({drink:c,category:p,ingredient:h});o.useEffect(()=>{t(f())},[t]),o.useEffect(()=>{t(f(w))},[p,h,c,t]),o.useEffect(()=>{const a=()=>{const m=window.innerWidth;m>=1280?r(9):m>=768?r(8):r(10)};return window.addEventListener("resize",a),a(),()=>{window.removeEventListener("resize",a)}},[i,d,n]);const x=Math.ceil(n.length/i),u=(d-1)*i,b=Math.min(u+i,n.length);return e.jsxs("main",{className:"container",children:[e.jsx(M,{text:"Drinks"}),e.jsxs(Z,{children:[e.jsx($,{setDrink:v}),e.jsx(G,{setCategory:y}),e.jsx(H,{setIngredient:S})]}),e.jsxs("div",{className:"categoryListsContainer",children:[l&&e.jsx(F,{}),!l&&n.length<1&&e.jsxs(J,{children:[e.jsx(V,{}),e.jsx("p",{children:"We haven't found any cocktails. Please try another filters."})]}),!l&&n.length>0&&e.jsx(E,{children:n.slice(u,b).map(a=>e.jsx(Q,{className:"drinksListItem",id:a._id,name:a.drink,img:a.drinkThumb},a._id))})]}),!l&&x>1&&e.jsx(A,{pageQuan:x})]})};export{ne as default};
