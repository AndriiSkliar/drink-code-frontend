import{r as c,u as a,a as p,j as e,p as v,b as l,q as w,t as b,v as h,w as x,N as S,c as C,L}from"./index-419dca2d.js";import{D,P as B}from"./Pagination-bfd3c1a6.js";import{d as F,e as P,f as I,g as z}from"./selectors-dad3d6eb.js";import{T as N}from"./Title-78efff1f.js";import{a as T,S as W,b as E,c as A,d as V,e as M}from"./DrinksItem.styled-142f2572.js";import{N as q}from"./NotFound-12825023.js";const O=r=>c.createElement("svg",{width:20,height:20,viewBox:"0 0 20 20",fill:"none",xmlns:"http://www.w3.org/2000/svg",...r},c.createElement("path",{d:"M9.16667 15.8333C12.8486 15.8333 15.8333 12.8486 15.8333 9.16667C15.8333 5.48477 12.8486 2.5 9.16667 2.5C5.48477 2.5 2.5 5.48477 2.5 9.16667C2.5 12.8486 5.48477 15.8333 9.16667 15.8333Z",stroke:"#F3F3F3",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round"}),c.createElement("path",{d:"M17.5 17.5L13.875 13.875",stroke:"#F3F3F3",strokeWidth:1.8,strokeLinecap:"round",strokeLinejoin:"round"})),_=a(O)`
  width: 28px;
  height: 28px;
...
`,J=h("drinks/getAll",async(r,n)=>{try{const{data:t}=await x.get("/drinks");return t}catch(t){return n.rejectWithValue(t.message)}});h("drinks/getByLetter",async(r,n)=>{try{const{data:t}=await x.get("/drinks/search",r);return t}catch(t){return n.rejectWithValue(t.message)}});h("drinks/getByCategory",async(r,n)=>{try{const{data:t}=await x.get("/drinks/search/category",r);return t}catch(t){return n.rejectWithValue(t.message)}});h("drinks/getByIngredient",async(r,n)=>{try{const{data:t}=await x.get("/drinks/search/ingredients",r);return t}catch(t){return n.rejectWithValue(t.message)}});const K=({id:r,name:n,img:t})=>e.jsxs(T,{children:[e.jsx(W,{children:e.jsx(E,{src:t,alt:n})}),e.jsxs(A,{children:[e.jsx(V,{children:n}),e.jsx(S,{to:`/drink/${r}`,children:e.jsx(M,{children:"See more"})})]})]}),oe=()=>{const r=p(),[n,t]=c.useState(8),[o,d]=C(),s=l(I),u=l(z),g=o.get("page")||1,m=Math.ceil(s.length/n),f=(g-1)*n,k=Math.min(f+n,s.length);return c.useEffect(()=>{r(J())},[r]),c.useEffect(()=>{const i=()=>{const y=window.innerWidth>=1200?9:8;y!==n&&t(y)};return window.addEventListener("resize",i),i(),()=>{window.removeEventListener("resize",i)}},[n,g,s]),e.jsxs("main",{className:"container",children:[e.jsx(N,{text:"Drinks"}),e.jsxs(U,{children:[e.jsx(G,{}),e.jsx(H,{}),e.jsx(Q,{})]}),e.jsxs("div",{className:"categoryListsContainer",children:[u&&e.jsx(L,{}),!u&&s.length<1&&e.jsxs(Z,{children:[e.jsx(q,{}),e.jsx("p",{children:"We haven't found any cocktails. Please try another filters."})]}),!u&&s.length>0&&e.jsx(D,{children:s.slice(f,k).map(i=>e.jsx(K,{className:"drinksListItem",id:i._id,name:i.drink,img:i.drinkThumb},i._id))})]}),m>1&&e.jsx(B,{pageQuan:m})]})};export{oe as default};
