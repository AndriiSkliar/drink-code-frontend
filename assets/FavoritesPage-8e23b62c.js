import{a as g,j as e,N as v,s as S,d as j,u as k,b as l,c as y,r as d,e as P,L as C}from"./index-b540e5e4.js";import{T as w}from"./Title-e7a7391f.js";import{D as F,P as D}from"./Pagination-2e9cf6b8.js";import{S as L,a as N,b as E,c as z,d as W,e as b,f as I,g as T}from"./DrinkCard.styled-88ee2970.js";import{s as M,a as B,b as R}from"./selectors-dad3d6eb.js";import{N as _}from"./NotFound-5c5f84b9.js";const $=({name:a,description:i,alcoholic:c,imgUrl:n,id:r})=>{const h=g(),o=s=>{h(j(s))};return e.jsxs(L,{children:[e.jsx(N,{src:n,alt:a}),e.jsxs("div",{children:[e.jsx(E,{children:a}),e.jsx(z,{children:c})]}),e.jsx(W,{children:i}),e.jsxs(b,{children:[e.jsx(v,{to:`/drink/${r}`,children:e.jsx(I,{children:"See more"})}),e.jsx(T,{onClick:()=>o(r),children:e.jsx("svg",{children:e.jsx("use",{xlinkHref:`${S}#icon-trash`})})})]})]})},A=k.div`
  margin-top: 40px;
  display: flex;
